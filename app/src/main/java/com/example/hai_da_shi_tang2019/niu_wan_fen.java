...
public class niu_wan_fen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_niu_wan_fen);
        ArrayAdapter<String> adapter=new ArrayAdapter<String>(niu_wan_fen.this,android.R.layout.simple_list_item_1,data);
