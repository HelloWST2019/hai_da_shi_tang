...
public class la_zi_ji_guo_zai extends AppCompatActivity {
...
"适用人群:\n" +
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_la_zi_ji_guo_zai);
        ArrayAdapter<String> adapter=new ArrayAdapter<String>(la_zi_ji_guo_zai.this,android.R.layout.simple_list_item_1,data);
