...
public class hao_you_niu_rou extends AppCompatActivity {
private String[]data={"蚝油是用蚝（牡蛎）熬制而成的调味料。蚝油是广东常用的传统的鲜味调料，也是调味汁类最大宗产品之一，它以素有\"海底牛奶\"之称的蚝牗牡蛎牍为原料，经煮熟取汁浓缩，加辅料精制而成。\n" +
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hao_you_niu_rou);
        ArrayAdapter<String> adapter=new ArrayAdapter<String>(hao_you_niu_rou.this,android.R.layout.simple_list_item_1,data);
