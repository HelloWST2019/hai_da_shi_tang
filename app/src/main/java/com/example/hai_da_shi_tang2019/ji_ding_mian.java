...
public class ji_ding_mian extends AppCompatActivity {
private String[]data={"将鸡肉拍松后切成一厘米见方的丁，并以此为主料做成的家常菜宫保鸡丁、辣子鸡丁、酱爆鸡丁、甜酱鸡丁等是饭店中常见的菜肴。\n" +
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ji_ding_mian);
        ArrayAdapter<String> adapter=new ArrayAdapter<String>(ji_ding_mian.this,android.R.layout.simple_list_item_1,data);
