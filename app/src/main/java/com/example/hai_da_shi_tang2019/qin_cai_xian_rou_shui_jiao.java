...
public class qin_cai_xian_rou_shui_jiao extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qin_cai_xian_rou_shui_jiao);
        ArrayAdapter<String> adapter=new ArrayAdapter<String>(qin_cai_xian_rou_shui_jiao.this,android.R.layout.simple_list_item_1,data);
