...
public class jin_zhen_gu_niu_liu extends AppCompatActivity {
private String[]data={"金针菇别名冬菇、朴蕈、绒毛柄金钱菌等，属真菌门、担子菌亚门、层菌纲、伞菌目、口蘑科、金钱菌属。金针菇在自然界广为分布，中国、日本、俄罗斯、欧洲、北美洲、澳大利亚等地均有种植。金针菇在我国分布广泛，栽培历史十分悠久，北起黑龙江，南至云南，东起江苏，西至新疆均适合金针菇的生长。 \n" +
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jin_zhen_gu_niu_liu);
        ArrayAdapter<String> adapter=new ArrayAdapter<String>(jin_zhen_gu_niu_liu.this,android.R.layout.simple_list_item_1,data);
