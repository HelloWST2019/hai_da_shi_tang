...
public class pao_cai_ji_rou_shi_guo_ban_fan extends AppCompatActivity {
private String[]data={"泡菜古称葅，是指为了利于长时间存放而经过发酵的蔬菜。一般来说，只要是纤维丰富的蔬菜或水果，都可以被制成泡菜；像是卷心菜、大白菜、红萝卜、白萝卜、大蒜、青葱、小黄瓜、洋葱、高丽菜等。蔬菜在经过腌渍及调味之后，有种特殊的风味，很多人会当作是一种常见的配菜食用。所以现代人在食材取得无虞的生活环境中，还是会制做泡菜。\n" +
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pao_cai_ji_rou_shi_guo_ban_fan);
        ArrayAdapter<String> adapter=new ArrayAdapter<String>(pao_cai_ji_rou_shi_guo_ban_fan.this,android.R.layout.simple_list_item_1,data);
