...
public class mo_gu_niu_rou_shi_guo_ban_fan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mo_gu_niu_rou_shi_guo_ban_fan);
        ArrayAdapter<String> adapter=new ArrayAdapter<String>(mo_gu_niu_rou_shi_guo_ban_fan.this,android.R.layout.simple_list_item_1,data);
