...
public class jun_gu_ji_dan_guo_zai extends AppCompatActivity {
private String[]data={"菌菇营养价值:\n" +
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jun_gu_ji_dan_guo_zai);
        ArrayAdapter<String> adapter=new ArrayAdapter<String>(jun_gu_ji_dan_guo_zai.this,android.R.layout.simple_list_item_1,data);
