...
public class yu_wan_san_xian_guo_zai extends AppCompatActivity {
...
"主要功效:\n" +
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yu_wan_san_xian_guo_zai);
        ArrayAdapter<String> adapter=new ArrayAdapter<String>(yu_wan_san_xian_guo_zai.this,android.R.layout.simple_list_item_1,data);
