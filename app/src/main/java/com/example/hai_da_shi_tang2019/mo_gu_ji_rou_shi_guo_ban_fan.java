...
public class mo_gu_ji_rou_shi_guo_ban_fan extends AppCompatActivity {
private String[]data={"蘑菇称为双孢蘑菇，又叫白蘑菇、洋蘑菇，隶属于伞菌目，伞菌科，蘑菇属，是世界上人工栽培较广泛、产量较高、消费量较大的食用菌品种，很多国家都有栽培，其中我国总产量占世界第二位。近年来，随着食用菌产业的快速发展，双孢蘑菇的产量也在逐年增加，成为许多地区农民增收的支柱产业。随着人民生活水平的提高，对蘑菇周年消费需求不断增加，双孢蘑菇的工厂化栽培也已开始实现\n" +
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mo_gu_ji_rou_shi_guo_ban_fan);
        ArrayAdapter<String> adapter=new ArrayAdapter<String>(mo_gu_ji_rou_shi_guo_ban_fan.this,android.R.layout.simple_list_item_1,data);
