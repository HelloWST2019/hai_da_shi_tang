...
public class tu_dou_fen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tu_dou_fen);
        ArrayAdapter<String> adapter=new ArrayAdapter<String>(tu_dou_fen.this,android.R.layout.simple_list_item_1,data);
