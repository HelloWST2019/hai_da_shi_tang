...
public class suan_cai_yu_guo_zai extends AppCompatActivity {
private String[]data={"营养价值:\n" +
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_suan_cai_yu_guo_zai);
        ArrayAdapter<String> adapter=new ArrayAdapter<String>(suan_cai_yu_guo_zai.this,android.R.layout.simple_list_item_1,data);
