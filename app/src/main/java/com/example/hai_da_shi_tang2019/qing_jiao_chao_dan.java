...
public class qing_jiao_chao_dan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qing_jiao_chao_dan);
        ArrayAdapter<String> adapter=new ArrayAdapter<String>(qing_jiao_chao_dan.this,android.R.layout.simple_list_item_1,data);
