...
public class rou_si_hui_dan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rou_si_hui_dan);
        ArrayAdapter<String> adapter=new ArrayAdapter<String>(rou_si_hui_dan.this,android.R.layout.simple_list_item_1,data);
