...
public class jun_gu_chao_tuo_tuo_rou extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jun_gu_chao_tuo_tuo_rou);
        ArrayAdapter<String> adapter=new ArrayAdapter<String>(jun_gu_chao_tuo_tuo_rou.this,android.R.layout.simple_list_item_1,data);
