...
public class xia_ren_hui_dan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xia_ren_hui_dan);
        ArrayAdapter<String> adapter=new ArrayAdapter<String>(xia_ren_hui_dan.this,android.R.layout.simple_list_item_1,data);
