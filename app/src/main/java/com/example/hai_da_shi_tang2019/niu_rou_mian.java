...
public class niu_rou_mian extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_niu_rou_mian);
        ArrayAdapter<String> adapter=new ArrayAdapter<String>(niu_rou_mian.this,android.R.layout.simple_list_item_1,data);
