...
public class qing_jiao_gan_si_rou_si extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qing_jiao_gan_si_rou_si);
        ArrayAdapter<String> adapter=new ArrayAdapter<String>(qing_jiao_gan_si_rou_si.this,android.R.layout.simple_list_item_1,data);
