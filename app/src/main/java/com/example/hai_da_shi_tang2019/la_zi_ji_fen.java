...
public class la_zi_ji_fen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_la_zi_ji_fen);
        ArrayAdapter<String> adapter=new ArrayAdapter<String>(la_zi_ji_fen.this,android.R.layout.simple_list_item_1,data);
