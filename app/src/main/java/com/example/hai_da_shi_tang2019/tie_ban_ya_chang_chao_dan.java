...
public class tie_ban_ya_chang_chao_dan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tie_ban_ya_chang_chao_dan);
        ArrayAdapter<String> adapter=new ArrayAdapter<String>(tie_ban_ya_chang_chao_dan.this,android.R.layout.simple_list_item_1,data);
