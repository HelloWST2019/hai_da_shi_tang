...
public class ji_rou_shi_guo_ban_fan extends AppCompatActivity {
private String[]data={"“石锅拌饭”又称“韩国拌饭”、“石碗拌饭”，朝鲜语돌솥비빔밥，是朝鲜半岛以及中国东北地区黑龙江、吉林、辽宁特有的米饭料理。 它的发源地为韩国全罗北道，后来演变为朝鲜半岛的代表性食物。是朝鲜半岛三大名菜（平壤冷面，开城汤饭，全州拌饭）之一。\n" +
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ji_rou_shi_guo_ban_fan);
        ArrayAdapter<String> adapter=new ArrayAdapter<String>(ji_rou_shi_guo_ban_fan.this,android.R.layout.simple_list_item_1,data);
