...
public class mi_zhi_cha_shao_fan extends AppCompatActivity {
private String[]data={"蜜汁叉烧，是香港十大经典名菜之一，也是广东省传统名菜之一，属于粤菜系。“叉烧”是从“插烧”发展而来的。主要以猪肉(瘦)、叉烧酱、蚝油、蒜、生抽、料酒、蜂蜜、白糖、花生油为原材料制作而成。\n" +
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mi_zhi_cha_shao_fan);
        ArrayAdapter<String> adapter=new ArrayAdapter<String>(mi_zhi_cha_shao_fan.this,android.R.layout.simple_list_item_1,data);
