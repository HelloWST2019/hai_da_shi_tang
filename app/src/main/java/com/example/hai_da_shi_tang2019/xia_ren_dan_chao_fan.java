...
public class xia_ren_dan_chao_fan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xia_ren_dan_chao_fan);
        ArrayAdapter<String> adapter=new ArrayAdapter<String>(xia_ren_dan_chao_fan.this,android.R.layout.simple_list_item_1,data);
