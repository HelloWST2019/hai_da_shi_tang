...
public class qing_jiao_niu_rou_gai_jiao_mian extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qing_jiao_niu_rou_gai_jiao_mian);
        ArrayAdapter<String> adapter=new ArrayAdapter<String>(qing_jiao_niu_rou_gai_jiao_mian.this,android.R.layout.simple_list_item_1,data);
