...
public class jun_gu_rou_pian extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jun_gu_rou_pian);
        ArrayAdapter<String> adapter=new ArrayAdapter<String>(jun_gu_rou_pian.this,android.R.layout.simple_list_item_1,data);
