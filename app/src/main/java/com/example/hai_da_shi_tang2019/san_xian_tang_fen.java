...
public class san_xian_tang_fen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_san_xian_tang_fen);
        ArrayAdapter<String> adapter=new ArrayAdapter<String>(san_xian_tang_fen.this,android.R.layout.simple_list_item_1,data);
